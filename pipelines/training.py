...
def training_pipeline(
    ...
    MODEL_NAMES: list[str] = ["cycle_at_model", "value_at_model"]
    ...
    if include_analysis:
        ...
        # parity plot
        cycle_train_predictions = models["cycle_at_model"].predict(preprocessor.X_train)
        cycle_test_predictions = models["cycle_at_model"].predict(preprocessor.X_test)

        capir_train_predictions = models["value_at_model"].predict(preprocessor.X_train)
        capir_test_predictions = models["value_at_model"].predict(preprocessor.X_test)
